...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(opt => opt.setName('recherche').setDescription('Nom ou URL YouTube').setRequired(true)),
  ...
  async execute(interaction, client) {
    ...
    if (!YTDLP) return interaction.reply({ content: '❌ yt-dlp non installé sur le serveur.', ephemeral: true });
